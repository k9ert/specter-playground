...
from .theme_manager import apply_style, remove_style, get_theme_manager, ThemeManager, get_style, get_color, get_font
...
__all__ = [
    ...
    'get_palette_entries',
    'apply_style', 'remove_style', 'get_theme_manager', 'ThemeManager',
